...
Sistema email end-to-end operativo (Sprint 3 chiuso 22 aprile 2026).
...
Cronologia sprint completati (0, 1, 2, 7, 7.X, 3) + roadmap pianificata + stats cumulate: **`docs/sprints.md`**.
...
Sprint più recente: **Sprint 3 Email** chiuso 22 aprile 2026 (vedi `docs/email-system.md`).
...
### Documenti split (v4.0, 2026-04-22)
- **`docs/gotchas.md`** — collezione completa gotcha tecnici §17.x con TOC per topic (Shadcn, Prisma, Next.js, Zod/RHF, Vercel/Build, PDF, UX, Settings, Domain)
- **`docs/email-system.md`** — Sprint 3 Email completo: architettura, 9 fasi, gotcha specifici (§17.25-27), file principali, env vars
- **`docs/sprints.md`** — cronologia sprint completati + roadmap pianificata + stats cumulate

### Documenti pre-esistenti
